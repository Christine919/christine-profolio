      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center px-6">
        ...
        >
          <div className="relative">
            {/* Creative Border */}
            <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-blue-500 rounded-lg transform -translate-x-2 -translate-y-2 z-10"></div>
            <div className="absolute inset-0 border-4 border-white rounded-lg z-20"></div>
            <img 
              src={profile} 
              alt="Profile" 
              className="rounded-lg shadow-lg z-30 relative" 
            />
          </div>
        </motion.div>
